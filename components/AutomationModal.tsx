              ...
              <div className="grid gap-4">
                 <div>
                   ...
                   <input 
                     ...
                     className="w-full mt-1 px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:ring-2 focus:ring-primary-500 outline-none"
                   />
                 </div>
                 ...
                 <div className="flex flex-col sm:flex-row gap-4 items-center">
                    <div className="flex-1 w-full">
                       ...
                       <select 
                         ...
                         className="w-full mt-1 px-3 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white outline-none"
                       >
                    ...
                    <div className="flex-1 w-full">
                       ...
                       <div className="flex gap-2">
                         <select 
                           ...
                           className="w-1/2 mt-1 px-2 py-2 text-sm border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white outline-none"
                         >
